...
f1 = 'county-to-county-by-sex-2006-2010-current-residence-sort.xls'
xl1 = os.path.join(p1, f1)

p2 = 'D:\\OneDrive\\Dissertation\\data\\ACS\\2011_2015'
f2 = 'county-to-county-by-sex-2011-2015-current-residence-sort.xlsx'
...
def main():
    ...
    for xl_file in xl_files:
        ...
        df.SEX.replace(to_replace=SEX_MAP, inplace=True)
    ...
    df.to_sql(name='acs_immigration_weights_sex_2006_2015',
              con=con,
              if_exists='replace',
              index=False)
    con.close()
