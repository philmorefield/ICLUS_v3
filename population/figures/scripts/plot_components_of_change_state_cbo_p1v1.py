...
FIGURES_FOLDER = os.path.join(BASE_FOLDER, 'figures', 'p1v1', 'components', 'state')
...
def get_projected_population():
    ...
    all_proj_pop['GEOID'] = all_proj_pop['GEOID'].str[:2]
...
def get_projected_births():
    ...
    all_proj_births['GEOID'] = all_proj_births['GEOID'].str[:2]
...
def get_projected_migration():
    ...
    all_proj_migration['GEOID'] = all_proj_migration['GEOID'].str[:2]
...
def get_projected_deaths():
    ...
    all_proj_deaths['GEOID'] = all_proj_deaths['GEOID'].str[:2]
...
def get_projected_immigration():
    ...
    all_proj_immigration['GEOID'] = all_proj_immigration['GEOID'].str[:2]
...
def main():
    ...
    for geoid, stname in st_name_to_fips.values:
        ...
        out_fn = f'state_components_of_change_{stname}_p1v1.png'
