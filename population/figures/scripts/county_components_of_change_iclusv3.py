...
COFIPS_LIST = ('48301',  # Loving County, TX
...
class FigureMaker():
    ...
    def get_historical_total_population(self):
        ...
        self.hist_pop_two = self.hist_pop_two.query('COFIPS == @self.cofips')
    ...
    def get_historical_births(self):
        ...
        self.hist_births_one = self.hist_births_one.query('COFIPS == @self.cofips')
        ...
        self.hist_births_two = self.hist_births_two.query('COFIPS == @self.cofips')
    ...
    def get_historical_deaths(self):
        ...
        self.hist_deaths_one = self.hist_deaths_one.query('COFIPS == @self.cofips')
        ...
        self.hist_deaths_two = self.hist_deaths_two.query('COFIPS == @self.cofips')
    ...
    def get_historical_migration(self):
        ...
        self.hist_migration_one = self.hist_migration_one.query('COFIPS == @self.cofips')
        ...
        self.hist_migration_one['YEAR'] = self.hist_migration_one['YEAR'].str.replace('DOMESTICMIG', '').astype(int)
        ...
        columns = ['STATE', 'COUNTY'] + ['DOMESTICMIG' + str(year) for year in range(2020, 2025)]
        ...
        self.hist_migration_two = self.hist_migration_two.query('COFIPS == @self.cofips')
        ...
        self.hist_migration_two['YEAR'] = self.hist_migration_two['YEAR'].str.replace('DOMESTICMIG', '').astype(int)
    ...
    def get_historical_immigration(self):
        ...
        self.hist_immigration_one = self.hist_immigration_one.query('COFIPS == @self.cofips')
        ...
        self.hist_immigration_two = self.hist_immigration_two.query('COFIPS == @self.cofips')
    ...
    def get_iclus_v3_projected_immigration(self):
        ...
        if self.iclusv3_immigration.empty:
            self.iclusv3_immigration = pd.DataFrame()
            self.iclusv3_immigration['YEAR'] = range(2021, 2100)
            self.iclusv3_immigration['IMMIGRATION'] = 0
        else:
...
def main():
    for cofips in COFIPS_LIST:
        FigureMaker(cofips=cofips)
