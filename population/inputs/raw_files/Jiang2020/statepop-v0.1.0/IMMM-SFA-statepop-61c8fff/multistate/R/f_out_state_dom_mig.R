#' Function to disaggregate total out-migration from each state
#'
...
#' @return data frame containing out-migration values from the current state to all other states
#' @export
#'
